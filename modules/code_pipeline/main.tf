resource "aws_s3_bucket" "source" {
  bucket        = "booksapi-experiment-source"
  acl           = "private"
  force_destroy = true
}
...
resource "aws_codebuild_project" "booksapi_build" {
  name          = "booksapi-codebuild"
  build_timeout = "10"
...
resource "aws_codepipeline" "pipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration {
        ProjectName = "booksapi-codebuild"
      }
    }
  }
